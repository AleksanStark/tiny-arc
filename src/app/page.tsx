  ...
  return (
    <>
      ...
      <main className={styles.container}>
        <section>
          <div className={styles.glamping_section}>
            <div className={styles.glamping_text_wrapper}>
              ...
              <p className={styles.glamping_text}>
                ...
                interiors, soft beds, modern amenities and everything you need
                for an unforgettable vacation. Located in picturesque places -
                by the lake, in the forest or in the mountains - our glampings
                give privacy and inspiration, turning your vacation into a real
